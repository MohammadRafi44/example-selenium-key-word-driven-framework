...
public class SeleniumListener extends AbstractWebDriverEventListener {
  ...
  public void beforeFindBy(By by, WebElement element, WebDriver driver) {
    LOGGER.info(String.format("Trying to find web element : %s ", by.toString()));
  }

  @Override
  public void afterFindBy(By by, WebElement element, WebDriver driver) {
    LOGGER.info(String.format("Found web element : %s ", by.toString()));
  }

  @Override
  public void beforeClickOn(WebElement element, WebDriver driver) {
    LOGGER.info(String.format("Trying to click web element : %s ", element.toString()));
  }

  @Override
  public void afterClickOn(WebElement element, WebDriver driver) {
    LOGGER.info(String.format("Clicked : %s ", element.toString()));
  }

  @Override
  public void beforeChangeValueOf(WebElement element, WebDriver driver, CharSequence[] keysToSend) {
    LOGGER.info(String.format("Value before send keys : [{}] for web element : [{}]%s | Value : %s", element.toString(), Arrays.toString(keysToSend)));
  }

  @Override
  public void afterChangeValueOf(WebElement element, WebDriver driver, CharSequence[] keysToSend) {
    LOGGER.info(String.format("After change value of web element : %s | Value : %s", element.toString(), Arrays.toString(keysToSend)));
  }

  @Override
  public void beforeScript(String script, WebDriver driver) {
    LOGGER.info(String.format("Trying to execute script : %s", script));
  }
  ...
  public void beforeGetText(WebElement element, WebDriver driver) {
    LOGGER.info("Trying to get text of web element : [{}]", element.toString());
  }
